...
import math
from .prior_utils.city_prior import NuscPrior
...
class NuscDataset(BaseMapDataset):
    ...
    def __init__(self, data_root, prior_type=None, prior_city_parts=None, prior_pc_ranges=None, **kwargs):
        ...
        if prior_type is not None:
            self.prior = NuscPrior(data_root, prior_city_parts, prior_pc_ranges, prior_type=prior_type)
    ...
    def get_sample(self, idx):
        ...
        if self.prior is not None:
            prior_points = self.prior.get_prior_points(location, e2g_translation=sample['e2g_translation'],
