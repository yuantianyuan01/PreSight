...
evaluation = dict(interval=num_epochs//3*num_iters_per_epoch)
find_unused_parameters = False #### when use checkpoint, find_unused_parameters must be False
checkpoint_config = dict(interval=num_epochs//6*num_iters_per_epoch, max_keep_ckpts=3)
...
SyncBN = True
# resume_from = "work_dirs/nusc_raster_priorsplit_480_100x50_24e/iter_15320.pth"