...
class NuScenesDataset(Custom3DDataset):
    ...
    def __init__(self,
                 ...
                 stereo=False,
                 prior_type=None,
                 prior_city_parts=None,
                 prior_pc_ranges=[-40, -40, -1.5, 40, 40, 6.0]):
        ...
        if prior_type is not None:
            self.prior = NuscPrior(data_root, 
                prior_city_parts, prior_pc_ranges, prior_type=prior_type)
    ...
    def get_data_info(self, index):
        ...
        if hasattr(self, "prior"):
            prior_points = self.prior.get_prior_points(location=info["location"], 
                                        e2g_translation=info["ego2global_translation"],
                                        e2g_rotation=info["ego2global_rotation"])
        input_dict['prior_points'] = prior_points
