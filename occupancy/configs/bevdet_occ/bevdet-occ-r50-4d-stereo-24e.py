...
test_data_config = dict(
    ...
    ann_file='/public/MARS/datasets/yuanty/nuScenes/' + 'bevdetv3-nuscenes_infos_val.pkl')
...
data = dict(
    ...
    train=dict(
        data_root=data_root,
        ann_file='/public/MARS/datasets/yuanty/nuScenes/' + 'bevdetv3-nuscenes_infos_train.pkl',
